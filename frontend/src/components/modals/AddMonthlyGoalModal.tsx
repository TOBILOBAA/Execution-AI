...
export function AddMonthlyGoalModal({
  ...
  const handleDelete = () => {
    ...
    if (!window.confirm("Delete this monthly goal? This cannot be undone.")) return;
    removeMonthlyGoal(initialData.id);
    onClose();
  };
      ...
      >
        ...
        <div className="px-8 py-7 space-y-6 overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                style={{
                  background: "#f7f9f8",
                  border: error && !yearlyGoalId ? "1.5px solid #ef4444" : "1.5px solid rgba(0,0,0,0.07)",
                  color: "#1a1f1e",
                }}
                onFocus={(e) => (e.currentTarget.style.border = "1.5px solid #006c4a")}
                onBlur={(e) => (e.currentTarget.style.border = error && !yearlyGoalId ? "1.5px solid #ef4444" : "1.5px solid rgba(0,0,0,0.07)")}
              >
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              placeholder="e.g., Launch the full dashboard planning flow"
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            >
              {isEdit ? "Save Changes" : "Create Monthly Goal"}
            </button>
          </div>
        </div>
      </div>
